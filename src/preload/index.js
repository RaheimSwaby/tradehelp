...
const api = {
  ...
  tradeDeletionSummary: (ids) => ipcRenderer.invoke('trades:deletionSummary', ids),
  ...
  deletePriceSeries: (root) => ipcRenderer.invoke('bars:delete', root),
  matchTradesToBars: (items) => ipcRenderer.invoke('bars:match', items),
  trimPriceBars: (root, padding) => ipcRenderer.invoke('bars:trim', root, padding),
  ...
  marketDataCapabilities: () => ipcRenderer.invoke('market-data:capabilities'),
  marketDataStatus: (provider) => ipcRenderer.invoke('market-data:status', provider),
  connectMarketData: (input) => ipcRenderer.invoke('market-data:connect', input),
  disconnectMarketData: (provider) => ipcRenderer.invoke('market-data:disconnect', provider),
  estimateMarketData: (input) => ipcRenderer.invoke('market-data:estimate', input),
  syncMarketData: (input) => ipcRenderer.invoke('market-data:sync', input),
  directionalBias: (instrument) => ipcRenderer.invoke('market-data:bias', instrument),
  ...
  openDetachedChart: (symbol) => ipcRenderer.invoke('app:openDetachedChart', symbol),
